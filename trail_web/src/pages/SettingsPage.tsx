...
export function SettingsPage() {
  ...
  useEffect(() => {
    ...
    setWeatherPrivateKey('')  // 已存储时不回显，placeholder 用 masked 值
      ...
      <section id="interface-weather" className={styles.section}>
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          <div className="field" style={{ flex: 1 }}>
            ...
            <input
              ...
              onChange={e => setWeatherProjectId(e.target.value)}
              placeholder="例：24E6AVXK6B"
              style={{ fontFamily: 'var(--mono)', fontSize: '13.5px' }}
            />
          </div>
          <div className="field" style={{ flex: 1 }}>
            ...
            <input
              className="field__input"
              value={weatherCredentialId}
              onChange={e => setWeatherCredentialId(e.target.value)}
              placeholder="例：TFB4P8GVXH"
              style={{ fontFamily: 'var(--mono)', fontSize: '13.5px' }}
            />
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          <div className="field" style={{ flex: 1 }}>
            ...
            <input
              className="field__input"
              value={weatherApiHost}
              onChange={e => setWeatherApiHost(e.target.value)}
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 16 }}>
          <button
            type="button"
            className="btn btn--primary"
            disabled={saveWeather.isPending}
            onClick={async () => {
